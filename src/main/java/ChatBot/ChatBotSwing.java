...
public class ChatBotSwing extends JFrame implements KeyListener {
    ...
    String chatBot[][] = {
        ...
        {"Dude! Coding is life", "Sleeping like a panda!", "Having my caffiene, You want some?", "Learning new tech like a nerd", "Being Geeky", "Answering you, blind fella!","Being witty to cut your cum inside"},
        //Negation 1
